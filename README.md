...
## 프로젝트 기획
### 프로젝트 설명
> 💡 대용량의 택배데이터를 활용, 택배를 전략적(Tactics)으로 검색, 관리할 수 있는 배송 관리 시스템 **TACBAETICS** 입니다.
...
2. 검색
    - 어드민 (물류센터 관리자) 
        ...
        - 지역별 배송담당자 배정표
        - 운송장 번호로 검색
        - 지역별, 고객명, 날짜, 배송담당자 등 필터를 통한 상세 조건 검색
    - 택배기사
...
- 효율적인 배송 관리 업무를 위한 각종 지표 모니터링
- 전략적인 배송을 위해서는 성능 뿐만아니라 기능 추가로 배송 효율성을 높일 수 있음에 포커스
	
2. 택배기사
	
- 효율적인 배송을 위한 배송완료 및 정산을 위한 택배 카운팅
...
> 대용량의 택배데이터를 활용, 택배를 전략적(Tactics)으로 검색, 관리할 수 있는 배송 관리 시스템
